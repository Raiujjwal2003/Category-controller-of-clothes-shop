      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-body">
              <form action="<?php echo site_url('admin/home/create_subcategory')?>" method="post">
                ...
                <div class="mb-3">
                    ...
                    <input name="subcategory_name" type="text" class="form-control"  required  >
                ...
                <div class="mb-3">
                    ...
                    <input name="subcategory_img" type="link" class="form-control"  required >
                    <div  class="form-text"> </div>
                </div>
